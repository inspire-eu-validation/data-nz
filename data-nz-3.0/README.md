...
The Data Specification on Natural Risk Zones – Technical Guidelines (version 3.0) and the associated GML application schema specifying requirements for the interoperability of spatial data sets of the data theme Natural Risk Zones.
...
| [Portrayal, Natural Risk Zones](http://inspire.ec.europa.eu/id/ats/data-nz/3.0/nz-portrayal) | INSPIRE view service |
...
5. The IR conformance classes for application schemas without non-abstract feature types, e.g. "Natural Risk Zones - Core", are not needed as no feature instance can be of a type from that application schema.
